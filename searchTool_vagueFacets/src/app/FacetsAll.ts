...
export var facetJSON = [
  ...
  {"name": "Processor Speed",
    "categorynames": ["under 2", "2.0 - 2.9", "3.0 - 3.9", "4.0 - 4.9", "5.0 - 5.9", "over 6.0"],
    "categorycounts": [-1, -1, -1, -1, -1, -1],
    "type": "interval",
    "borders": [[0.0, 2.0], [2.0, 3.0], [3.0, 4.0], [4.0, 5.0], [5.0, 6.0], [6.0, 10.0]],
    "values": [],
...
export var facetJSONvague = [
 ...
 {"name": "Brand",
    "categorynames": ['low reputation','reputable','high reputation'],
